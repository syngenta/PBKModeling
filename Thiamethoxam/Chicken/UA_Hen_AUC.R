...
write.csv(SA_AUC_chicken, "C:/xxx/OneDrive - Syngenta/HTTK/Bird/TMX/Laying hen/SA_AUC_chicken.csv")
write.csv(stat, "C:/xxx/OneDrive - Syngenta/HTTK/Bird/TMX/Laying hen/UA_AUC_chicken.csv")
