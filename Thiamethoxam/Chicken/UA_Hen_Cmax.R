...
write.csv(SA_Cmax_chicken, paste(file_path, '/SA_Cmax_chicken.csv', sep = ''), row.names = FALSE)
...
file_path     <- file.path(current_dir, "HTTK", "Bird", "TMX", "Laying hen")
write.csv(stat, paste(file_path, '/UA_Cmax_chicken.csv', sep = ''), row.names = FALSE)
