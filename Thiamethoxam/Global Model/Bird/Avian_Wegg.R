...
pbtk5cpt_repeated <- function(t, state, parameters) {
  with(as.list(c(state, parameters)), {
    ...
    Mass_stored_out          = Mass_parent_stored + Mass_daughter_stored + Aven_parent_out + Mass_daughter_out                    # Total Amount of Parent and daughter in the Body and Excreted (??mol)
