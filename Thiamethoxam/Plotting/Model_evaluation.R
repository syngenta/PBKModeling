...
df_320ppm      <- read.csv(paste(file_path, '/quail.adlib.320ppm.csv', sep =''))
df_1000ppm     <- read.csv(paste(file_path, '/quail.adlib.1000ppm.csv', sep =''))
df_2000ppm     <- read.csv(paste(file_path, '/quail.adlib.2000ppm.csv', sep =''))
df_3200ppm     <- read.csv(paste(file_path, '/quail.adlib.3200ppm.csv', sep =''))
...
ggsave("Evaluation_quail.tiff",scale = 1,
       plot = p1,
       path = file.path(current_dir, "HTTK", "Bird", "TMX", 'Plots', 'Quail'),
...
print(current_dir)
file_path                      <- file.path(current_dir, "HTTK", "Bird", "TMX", 'InvivoData.xlsx')
Metabolism_1998_7.66           <- read_excel(file_path, sheet = study1)
Metabolism_1998_7.92           <- read_excel(file_path, sheet = study2)
...
# 7.66
df_7.66_eggwhite          <- read.csv(paste(file_path, '/hen.eggwhite.oral.7.66mgkg.csv', sep=''))
df_7.66_eggyolk.CTD       <- read.csv(paste(file_path, '/hen.eggyolk.CTD.oral.7.66mgkg.csv', sep=''))
df_7.66_eggyolk.TMX       <- read.csv(paste(file_path, '/hen.eggyolk.TMX.oral.7.66mgkg.csv', sep=''))
df_7.66_rest              <- read.csv(paste(file_path, '/hen.oral.7.66mgkg.csv', sep=''))
...
# 7.92
file_path                 <- file.path(current_dir, "HTTK", "Bird", "TMX", 'Plots', 'Hen')
df_7.92_eggwhite          <- read.csv(paste(file_path, '/hen.eggwhite.oral.7.92mgkg.csv', sep=''))
df_7.92_eggyolk.CTD       <- read.csv(paste(file_path, '/hen.eggyolk.CTD.oral.7.92mgkg.csv', sep=''))
df_7.92_eggyolk.TMX       <- read.csv(paste(file_path, '/hen.eggyolk.TMX.oral.7.92mgkg.csv', sep=''))
df_7.92_rest              <- read.csv(paste(file_path, '/hen.oral.7.92mgkg.csv', sep=''))
...
ggsave("Evaluation_hen.tiff",scale = 1,
       plot = p1,
       path = file.path(current_dir, "HTTK", "Bird", "TMX", 'Plots', 'Hen'),
       width = 15, height = 15, units = "cm", dpi=600, compression = 'lzw')
